...
type User struct {
	...
	KillSwitchEnabled bool     `gorm:"default:false" json:"kill_switch_enabled"`
	TermsAccepted     bool     `gorm:"default:false" json:"terms_accepted"`
	DailyRewardCount int     `gorm:"default:0" json:"daily_reward_count"`
...
type AdLog struct {
	...
	AdType        string    `gorm:"index;size:16" json:"ad_type"`
